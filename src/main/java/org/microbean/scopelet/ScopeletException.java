...
/**
 * A {@link RuntimeException} indicating a problem with a {@link Scopelet}.
 *
...
public class ScopeletException extends RuntimeException {
  ...
  /**
   * Creates a new {@link ScopeletException}.
   */
   ...
   * Creates a new {@link ScopeletException}.
   *
   * @param cause a {@link Throwable} that caused this {@link ScopeletException} to be created; may be {@code null}
   */
